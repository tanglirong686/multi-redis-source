...
import com.multiple.data.source.database.runner.RedisMultiSourceRegisterRunner;
...
@Documented
@Import({RedisMultiSourceRegisterRunner.class,RedisMultiDataSourceRegistrar.class})
